...
function FriendRequests() {
  ...
  useEffect(() => {
    async function getReq() {
      try {
        const res = await axios.get("http://ec2-13-53-32-227.eu-north-1.compute.amazonaws.com/user/friendreq", {
  ...
  let acceptConnection = async (id) => {
    try {
      const res = await axios.patch(
        "http://ec2-13-53-32-227.eu-north-1.compute.amazonaws.com/connection/review",
        {
          connectionId: id,
          action: "accepted"
        },
